...
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002472272745')) # The movie you upload in it will be deleted from the bot.
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '0'))
auth_channel = environ.get('AUTH_CHANNEL', '')
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '0'))
request_channel = environ.get('REQUEST_CHANNEL', '-1002467839537') # If anyone sends a request message to your bot, you will get it in this channel.
...
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/ShinchanDubber/1506")
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/ShinchanDubber/1506")
...
#---------------------------------------------------------------
#---------------------------------------------------------------
START_IMG = (environ.get('START_IMG', 'https://graph.org/file/da50d5541aeb316cabd4e-ece510907a5bc14bc0.jpg')).split()
FORCESUB_IMG = environ.get('FORCESUB_IMG', 'https://i.ibb.co/ZNC1Hnb/ad3f2c88a8f2.jpg')
REFER_PICS = (environ.get("REFER_PICS", "https://envs.sh/PSI.jpg")).split() 
PAYPICS = (environ.get('PAYPICS', 'https://graph.org/file/d88c4ceb757dbfe2e333d-3d1b24dcf68a6e3390.jpg')).split()
